...
function LoginForm({setIsLoggedIn}) {
  ...
  return (
   ...
   <label className=' w-full '>
    ...
    <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' required type='email' value={formData.email} onChange={changeHandler} placeholder='enter email Address' name='email'></input>
   </label>
