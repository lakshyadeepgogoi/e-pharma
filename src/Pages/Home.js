...
function Home() {
  return (
    <div className='w-full h-full'>
        <div>
            <img src={landing} alt='landing' className='w-[90%] h-48 sm:h-full  sm:w-11/12 object-cover mt-6 mb-8 m-auto rounded-3xl '/>
        </div>
        ...
        {/* search bar options */}
            ...
            <div className='w-full my-4'>
                <div className='sm:text-center font-bold mt-6 mb-4 sm:text-2xl text-xl flex flex-row sm:flex-none justify-between  items-center'> <div className='sm:mx-auto'>Best Selling Product </div><div className='text-base sm:hidden text-[#006AFF]'>More</div></div>
            ...
            <div className='mt-10'>
                <div className='flex flex-row w-full h-16 gap-2 sm:gap-4 items-center justify-start sm:justify-center' >
                    <div className='text-[#184363 text] text-xl sm:text-2xl font-bold'>Deal Of The Week</div>
                    <div className='flex flex-row gap-3 h-full'>
                        <div className='w-12 h-full bg-[#15A9E3] flex flex-col justify-center items-center rounded-lg'><div className='text-xl font-bold'>71</div> <div>Days</div></div>
                        <div className='w-12 h-full bg-[#15A9E3] flex flex-col justify-center items-center rounded-lg'><div  className='text-xl font-bold'>19</div><div>Hours</div></div>
                        <div className='w-12 h-full bg-[#15A9E3] flex flex-col justify-center items-center rounded-lg'><div  className='text-xl font-bold'>25</div><div>Min</div></div>
                        <div className='w-12 h-full bg-[#15A9E3] flex flex-col justify-center items-center rounded-lg'><div  className='text-xl font-bold'>11</div><div>Sec</div></div>
                    </div>
                </div>
                {/* products */}
                <div>
